...
import { Send, Mail, ShieldCheck, User, MessageCircle, CheckCircle, Globe, Loader2, AlertCircle } from 'lucide-react';
import { CONTACT_API_URL, SITE_DETAILS } from '../config';
          ...
          <div className="lg:col-span-5 xl:col-span-4 ">
            ...
            >
              ...
              <div>
                ...
                <a href={`mailto:${SITE_DETAILS.email}`} className="text-xl font-bold text-zinc-900 hover:text-blue-700 transition-colors">{SITE_DETAILS.email}</a>
              </div>
            </a>
          </div>
